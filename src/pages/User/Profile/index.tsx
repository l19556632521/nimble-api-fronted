import {
    ...
    updateUserUsingPOST,
    userLoginUsingPOST,
} from '@/services/nimble-api-backend/userController';
...
import {uploadFileUsingPOST} from "@/services/nimble-api-backend/fileController";
    ...
    return (
        <PageContainer>
            <Row gutter={24}>
                <Col span={8}>
                    <Card title="个人信息" bordered={false}>
                        ...
                        <Row>
                            <Col>
                                <VerifiedOutlined /> 用户简介：{data?.userProfile}
                            </Col>
                        </Row>
                        <Divider />
                        <Row>
                ...
                <Col span={16}>
                    <Card title="你的秘钥" bordered={false}>
                        <Row>
                            <Col>
                                {visible ? (
                                    <Paragraph
            ...
            >
                ...
                >
                    <ProFormText.Password name="userPassword" placeholder="请输入用户密码"  autocomplete="off"/>
                </ProForm>
            </Modal>
        </PageContainer>
    );
