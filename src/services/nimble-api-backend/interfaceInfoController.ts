...
/** invokeInterfaceInfoById POST /api/interfaceInfo/invoke */
export async function invokeInterfaceInfoByIdUsingPOST(
...
/** offlineInterfaceInfoById POST /api/interfaceInfo/offline */
export async function offlineInterfaceInfoByIdUsingPOST(
  body: API.IdRequest,
  options?: { [key: string]: any },
) {
...
/** onlineInterfaceInfoById POST /api/interfaceInfo/online */
export async function onlineInterfaceInfoByIdUsingPOST(
  body: API.IdRequest,
  options?: { [key: string]: any },
) {
